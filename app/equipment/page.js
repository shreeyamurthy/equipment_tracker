      ...
      <div>
        ...
        <div className="container mx-auto mt-8">
          <div className="flex justify-center mb-4 space-x-4">
            <label className="block text-gray-700 font-bold mb-2">Select Equipment Type</label>
            <select
              value={selectedType}
          ...
          <div className="w-3/4 mx-auto space-y-4">
            {equipment.map((item) => (
              <div key={item.id} 
                className="relative bg-white p-4 rounded shadow-md border border-gray-200"
